...
class FareCalendarDatePicker extends StatefulWidget {
  ...
  @override
  State<FareCalendarDatePicker> createState() => _CalendarDatePicker2State();
}

class _CalendarDatePicker2State extends State<FareCalendarDatePicker> {
  ...
  @override
  void didUpdateWidget(FareCalendarDatePicker oldWidget) {
