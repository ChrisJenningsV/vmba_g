...
enum FareCalendarDatePickerType {
  single,
  multi,
...
class FareCalendarDatePickerConfig {
  FareCalendarDatePickerConfig({
    FareCalendarDatePickerType? calendarType,
    DateTime? firstDate,
    DateTime? lastDate,
    ...
    this.monthChange,
  })  : calendarType = calendarType ?? FareCalendarDatePickerType.single,
  ...
  final FareCalendarDatePickerType calendarType;
  ...
  /// Only applicable when [calendarType] is [FareCalendarDatePickerType.range]
  ...
  // Function to notify month change
  void Function(DateTime newDate)? monthChange;
  ...
  FareCalendarDatePickerConfig copyWith({
    FareCalendarDatePickerType? calendarType,
    DateTime? firstDate,
    DateTime? lastDate,
    DateTime? currentDate,
    ...
    return FareCalendarDatePickerConfig(
...
class CalendarDatePicker2WithActionButtonsConfig
    extends FareCalendarDatePickerConfig {
