...
//    int maxCol = 0;
 ...
 /*     // new List<Widget>();
      ...
      indexColumn++) {
        ...
        bool selected = false;
        if (selectedSeats != null && seat != null  && selectedSeats.contains(seat!.sCode)) {
          //color = gblSystemColors.seatPlanColorSelected;
          selected = true;
          selectableSeat = false;
        }
        ...
        if (seat == null && indexRow != 1) {
          ...
          seat!.sCellDescription = 'Occupied';
          row.add(
            Padding(
                padding: EdgeInsets.all(cellPadding),
                // blocked
                child: hookUpSeat(seat, false, false),
                //_getSeat(seat,false) ,
                *//*Container(
                  width: cellSize,
                  height: cellSize,
...
*//*
          ...
          row.add(hookUpSeat(seat, selected, selectableSeat));
            *//*Padding(
              padding: EdgeInsets.all(cellPadding),
