...
Widget vidCard( String caption,  Widget body, {bool wantTop = true,}) {
  return Padding(padding: EdgeInsets.only(top:2, left: 3, right: 3, bottom: 0),
      child: Card(
        color: gblSettings.homePageStyle == 'V3' ? Colors.grey.shade200 : null,
        elevation: 3,
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.all( Radius.circular(gblSettings.homePageStyle=='V3' ? 10 : 3))
        ),
        child: ClipPath(
          child: Container(
 //           height: 100,
          ...
          clipper: ShapeBorderClipper(shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(gblSettings.homePageStyle=='V3' ? 20 : 3))),
        ),
      ));
}